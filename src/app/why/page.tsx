...
const Why = () => {
  return (
    <div className="flex flex-col bg-[#012527] pt-20 pb-10 md:pb-26 md:pt-36 px-4 sm:px-8 md:px-10 lg:px-20 gap-16 md:gap-20">
      <div>
        There are tons of benefits that come with taking some time to wander the
        great outdoors as you travel!
      ...
      <div className="flex flex-col md:flex-row gap-2">
        ...
        <div className="flex flex-col md:w-[65vw] px-6 sm:px-10 lg:px-14 py-10 gap-8 bg-[#012E30] text-[#C8EAEE]">
          ...
          <div>
            Over time, we have developed a shorter attention span and are often
            in search of instant gratification when it comes to entertaining
            ourselves. If going outside and hiking two miles fails to capture
            the imagination, we might decide to opt out and instead do something
            more engaging on our travels.
          </div>
          <div>
            ...
            After all, we weren't meant to seclude ourselves indoors, staring at
            white walls for most of our days!
          </div>
          <div>
            There are{" "}
            <span className="text-[#16858B]">
            ...
            can get caught up in. If you're an avid traveler, being outside and
            taking the time to connect with nature is a welcome respite from
            hustling between sightseeing spots. It gives you time to recharge,
            soak up some sun, and restore your energy.
          </div>
          <div>
            Not the most outdoorsy person? You're in luck! You don't need to
            spend a week roughing it in the depths of the wilderness in order to
            reap the{" "}
            <span className="text-[#16858B]">
          ...
          <div>
            ...
            beaten path with friends or family for extended periods of time and
            you're sure to have a fun-filled trip that will leave you feeling
            refreshed.
          </div>
          <div>
